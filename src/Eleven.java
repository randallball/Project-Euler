...
public class Eleven{
	...
	{
		//outer array going down the colomn, inner arrays going across rows.
		...
		System.out.println(down(grid));
		System.out.println(right(grid));
		System.out.println(rightDiagonal(grid));
		System.out.println(leftDiagonal(grid));
	}
	...
	public static int rightDiagonal(int[][] grid)
	{
		int prod = 1;
		List<Integer> product = new ArrayList<Integer>();
		for (int i = 0; i < 17; i++)
	...
	public static int leftDiagonal(int[][] grid)
	{
		int prod = 1;
		List<Integer> product = new ArrayList<Integer>();
		for (int i = 0; i < 17; i++)
